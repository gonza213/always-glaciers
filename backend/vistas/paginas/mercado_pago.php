...
<div class="content-wrapper" style="min-height: 613px;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Mercado Pago</h1>
                </div><!-- /.col -->
                                                            ...
                                                            <?php if ($value['metodo_pago'] == "Mercado Pago") : ?>
                                                                <tr role="row" class="odd">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a class="btn btn-danger text-white btnBorrarMercado" idMercado="<?php echo $value["id"] ?>"><i class="fa fa-trash"></i></a>
                                                                    </td>
                                                                </tr>
                                                            <?php endif; ?>
                                                        <?php endforeach; ?>
                                                            ...
                                                            <?php foreach ($mercado_carrito as $key => $value) : ?>
                                                                <?php if ($value['metodo_pago'] == "Mercado Pago") : ?>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a class="btn btn-danger text-white btnBorrarMercadoCarrito" idMercadoCarrito="<?php echo $value["id"] ?>"><i class="fa fa-trash"></i></a>
                                                                    </td>
                                                                </tr>
                                                            <?php endif; ?>
                                                        <?php endforeach; ?>
                                                        ...
                                                        <?php foreach ($mercado_renta as $key => $value) : ?>
                                                            ...
                                                            <?php foreach ($mercado_renta as $key => $value) : ?>
                                                                <?php if ($value['metodo_pago'] == "Mercado Pago") : ?>
                                                                    ...
                                                                    <td>
                                                                        <!-- <a class="btn btn-info text-white btnVerMercadoCarrito" idMercadoCarrito="<?php echo $value["id"] ?>" data-toggle="modal" data-target="#exampleModalCarrito"><i class="fa fa-eye"></i></a> -->
                                                                        <a class="btn btn-danger text-white btnBorrarMercadoRenta" idMercadoRenta="<?php echo $value["id"] ?>"><i class="fa fa-trash"></i></a>
                                                                    </td>
                                                                </tr>
                                                            <?php endif; ?>
                                                        <?php endforeach; ?>
...
$borrarMercado->ctrBorrarMercado();
...
$borrarMercadoRenta->ctrBorrarMercadoRenta();

?>

<?php

$borrarMercadoCarrito = new ControllerMercado();
$borrarMercadoCarrito->ctrBorrarMercadoCarrito();
