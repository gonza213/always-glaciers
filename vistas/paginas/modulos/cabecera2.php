...
<header class="mainhead header-fixed" id="noimprime">
    <div id="cabezeraGris" class="oe-header oe-header-float2">
        <div class="container">
            ...
            <div class="row">
                ...
                <?php endif ?>
            <?php endforeach; ?>
            <a href="#datepickerReserva" class="hidden-lg hidden-md btn-reservas-xs"><strong>RESERVAR</strong></a>
            <a onclick="window.print()" style="cursor: pointer" class="hidden-xs hidden-sm"><span class="btn-faqs"><i class="fa fa-print"></i></span></a>
