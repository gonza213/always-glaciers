        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-4 col-sm-3 col-md-3 col-lg-2 padd-reservar-resp" style="text-align:right;">
                    ...
                    <a onclick="window.print()" style="cursor: pointer" class="hidden-xs hidden-sm"><span
                            class="btn-faqs"><i class="fa fa-print"></i></span></a>
            ...
            <ul class="uk-nav uk-nav-offcanvas" id="monedaSelect2">
                <li class="menu-item menu-item-has-child col-1"><a href="#">Moneda</a>
                    <ul class="submenu ">
                        ...
                        <li class="tit-menu-idioma-item"><a href="index-usd" class="selectOption" value="7"
