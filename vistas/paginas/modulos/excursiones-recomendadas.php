                    ...
                    <div class="modulo-destacados">
                        <section>
                            <span>
                                ...
                                <img src="<?php echo $servidor . $value["banner"]; ?>" class="img-fluid"
                                    style="width: 320px !important; height: 260px !important">
                                <form id="my_form<?php echo $value["id"]; ?>" method="post"
                                    action="index.php?pagina=reserva&id=<?php echo $value["id"]; ?>&categoria=<?php echo $value["category"]; ?>">
                        ...
                        <div class="col-md-12 transferencia">
                            <span class="small text-white"></span>
                            <a class="btnExcursion" href="index.php?pagina=transferencia&id=<?php echo $value["id"]; ?>" idExcursion="<?php echo $value["id"]; ?>" ><span class="small text-white"
                                    style="font-weight: bold;"><i class="fa fa-arrow-right"></i> Paga
                                    con transferencia
                                    bancaria y ahorra 1,5%</span></a>
                        </div>
