                            ...
                            <div class="mod-lista-excu">
                                ...
                                <sup id="moneda2"></sup>
                                    ...
                                    <div class="col-md-12 transferencia">
                                        ...
                                        <a class="btnExcursion" idExcursion="<?php echo $value["id"]; ?>" data-toggle="modal" data-target="#exampleModal" style="cursor:pointer"><span class="small text-white" style="font-weight: bold;"><i class="fa fa-arrow-right"></i> Paga
                                                con transferencia
