                ...
                <div class="hidden-xs hidden-sm visible-md visible-lg">
                        ...
                        <nav class="oe-mainmenu">
                            <ul class="oe-menu-dad">
                                ...
                                <li class="menu-item menu-item-has-child col-1 current-menu-item"><a
                                        href="<?php echo $rutas ?>">Inicio</a></li>
                                <li class="menu-item menu-item-has-child col-1"><a href="#">Excursiones</a>
                                    <ul class="submenu ">
                                        <?php foreach ($nav as $key => $value) : ?>
                                        <?php if ($value["categoria"] == "excursiones") : ?>
                                        <li><a
                                                href="index.php?pagina=excursiones&id=<?php echo $value["id"]; ?>"><?php echo $value["subcategoria"] ?></a>
                                        </li>
                                        <?php endif; ?>
                                        <?php endforeach; ?>
                                    </ul>
                                ...
                                <li class="menu-item menu-item-has-child col-1"><a href="#">Lugares de Interés</a>
                                    <ul class="submenu ">
                                        ...
                                        <li><a
                                                href="index.php?pagina=lugares&id=<?php echo $value["id"]; ?>"><?php echo $value["subcategoria"] ?></a>
                                        </li>
                                        <?php endif; ?>
                                        <?php endforeach; ?>
                                    </ul>
                                ...
                                <li class="menu-item menu-item-has-child col-1"><a href="#">Buses Regulares</a>
                                    <ul class="submenu ">
                                        ...
                                        <li><a
                                                href="index.php?pagina=buses&id=<?php echo $value["id"]; ?>"><?php echo $value["subcategoria"] ?></a>
                                        </li>
                                        <?php endif; ?>
                                        <?php endforeach; ?>
                                    </ul>
                                ...
                                <li class="menu-item menu-item-has-child col-1"><a
                                        href="index.php?pagina=renta&id=<?php echo $value["id"]; ?>">Renta Car</a>
                                    <?php endif; ?>
                                    <?php endforeach; ?>
                                </li>
                                <li class="menu-item menu-item-has-child col-1"><a
                    ...
                    <div class="col-md-12 resp-nav">
                        ...
                        <nav class="oe-mobile-menu">
                            <ul class="oe-menu-dad">
                                <li class="menu-item current-menu-item"><a href="index">Inicio</a></li>
                                <li class="menu-item menu-item-has-child col-1"><a href="#">Excursiones</a>
                                    <ul class="submenu ">
                                        <?php foreach ($nav as $key => $value) : ?>
                                        <?php if ($value["categoria"] == "excursiones") : ?>
        ...
        <div class="uk-offcanvas-bar uk-offcanvas-bar-flip">
            ...
            <div class="" id="idiomaSelect2">
                ...
                <form method="POST" action="<?php echo "http://" . $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"] ?>">
                    ...
                    <img src="vistas/assets/img/arg.svg" alt="Español" width="30" height="21">
                    <input type="submit" translate="no" class="menu-item col-1 current-menu-item"
                        style="cursor:pointer; background:none; border: none" value="Español">
                ...
                <form method="POST" action="<?php echo "http://" . $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"] ?>">
                    ...
                    <img src="vistas/assets/img/usa.svg" alt="Español" width="30" height="21">
                    <input type="submit" class="menu-item col-1 current-menu-item"
                        style="cursor:pointer; background:none; border: none" value="English">
                </form>
                </p>

                <div id="ytWidget" style="display: none"></div>
                <script
                    src="https://translate.yandex.net/website-widget/v1/widget.js?widgetId=ytWidget&pageLang=es&widgetTheme=light&autoMode=true"
            ...
            <ul class="uk-nav uk-nav-offcanvas" id="monedaSelect2">
                <li class="menu-item menu-item-has-child col-1"><a href="#">Moneda</a>
                    <ul class="submenu ">
                        ...
                        <li class="tit-menu-idioma-item"><a href="#selectOption" class="selectOption" value="7"
                                data-valor="83" data-codigo="USD" data-descripcion="Dólares Americanos">USD Dólares
                                Americanos</a></li>
