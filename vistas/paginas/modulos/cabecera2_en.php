        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-3 col-sm-3 hidden-md hidden-lg p-0-resp" style="position:relative;">
                    ...
                    <div class="hidden-lg offset-canvas-btn" style="position:absolute;top:14px;text-align:left;left:0;margin-left:0;">
                        <a href="javascript:" data-uk-offcanvas="{target:'#offcanvasMain'}" class="margen-nav"><i class="fa fa-navicon"></i></a>
                    </div>
                </div>
                <div class="col-xs-5 col-sm-6 col-md-2 col-lg-2 p-0-resp" style="text-align:center;">
                    ...
                    <div class="visible-xs p-0-resp">
                        <a href="<?php echo $rutas ?>">
                            <img style="margin-top:8px;" src="vistas/assets/img/logo@2x.png" width="110" height="50" alt="AlwaysGlaciers">
                        </a>
                    </div>
                </div>
                <div class="col-lg-8 col-md-7 hidden-xs hidden-sm visible-md visible-lg header-tit-excursiones" style="text-align:left;padding-left:0;">
                    <div style="width:100%">
                ...
                <div class="col-xs-4 col-sm-3 col-md-3 col-lg-2 padd-reservar-resp" style="text-align:right;">
                    <a href="#ancla" class="hidden-xs hidden-sm">
                        <button class="btn oe-btn oe-btn-reflect oe-btn-hover-flap btn-reservar-car">
                            <span data-btn-text="$ <?php echo $value["precio_bajo"] ?>">RESERVAR</span> <i class="fa fa-shopping-cart"></i>
                        </button>
                    </a>
                <?php endif ?>
            <?php endforeach; ?>
            <a href="#ancla" class="hidden-lg hidden-md btn-reservas-xs"><strong>RESERVAR</strong></a>
            <a href="https://www.AlwaysGlaciers.com/contacto.php" class="hidden-xs hidden-sm"><span class="btn-faqs"><i class="fa fa-question-circle"></i></span></a>
            <div class="hidden-xs hidden-sm desktop-show offset-canvas-btn" style="display:inline-block;position:absolute;top:18px;right:15px;">
            ...
            <div class="oe-custom-search-form col-xs-12" id="searchForm">
                <form action="" method="get">
                    <div class="search-box" id="searchBox">
                        <input type="text" class="search-input" id="searchInput" name="search" placeholder="Escriba aquí...">
    ...
    <div id="offcanvasMain" class="uk-offcanvas">
        <div class="uk-offcanvas-bar uk-offcanvas-bar-flip">
            ...
            <ul class="uk-nav uk-nav-offcanvas">
                <li class="menu-item col-1 current-menu-item"><a href="<?php echo $rutas ?>">Inicio</a></li>
                ...
                <?php foreach ($nav as $key => $value) : ?>
                    <?php if ($value["categoria"] == "renta") : ?>
                        <li class="menu-item  col-1"><a href="index.php?pagina=renta&id=<?php echo $value["id"]; ?>">Renta
                                Car</a>
                        <?php endif; ?>
                    <?php endforeach; ?>
            ...
            <div class="oe-mtop text-center" style="width:100%;">
                <div class="row text-center">
                    <div style="display:inline-block;margin:0 8px;"><a href="https://www.facebook.com/AlwaysGlaciers" target="_blank"><i class="fa fa-lg fa-facebook-square"></i></a></div>
