    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class=" bg-color-con-borde">
                ...
                <?php include "modulos/excursiones-recomendadas.php"; ?>
                <!-- FIN EXCURSIONES -->

                <!-- BUSES RECOMENDADAS -->
                <?php include "modulos/buses-recomendadas.php"; ?>
                <!-- FIN BUSES -->


                <!-- RENTA RECOMENDADAS -->
                <?php include "modulos/renta-recomendadas.php"; ?>
                <!-- FIN RENTA -->
                ...
                <section class="container-fluid oe-fullwidth oe-mbot-2x m-t-b-10">
                    <div class="row oe-row oe-row-fullwidth uk-scrollspy-init-inview uk-scrollspy-inview animate-started"
                        ...
                        <div class="col-xs-12 oe-main-col text-center oe-effects oe-frombottom oe-animate-delay"
                            ...
                            <h2 class="oe-heading-5">¿ESTÁS LISTO?</h2>
                            <div class="row oe-pad-normal oe-pad-notop">
                                <button class="btn oe-btn oe-btn-reflect oe-btn-3d-box toTop"><a
                                        href="#datepickerEntrada"><span data-btn-text="ORGANICE SU VIAJE"
                                            class="f-s-18">PLANIFICA TU VIAJE</span></a></button>
                            </div>
                        </div>
                    </div>
                </section>

                <section class="container" style="padding: 10px; background-color: whitesmoke; border-radius: 10px;">
                    <div class="row">
                        <div class="col-md-12 ">
                            <div class="col-md-3"></div>
                            <div class="col-md-6 mx-auto text-center">
                                <h6 class="text-white"><img src="vistas/images/icon-10.png" alt="Tarjetas"
                                        style="padding: 5px;" />
                                    <span style="font-weight:bold; color: #257bb4">25 años</span> dando el mejor
                                    servicio en el sur a más de <span style="font-weight:bold; color: #257bb4">340.000
                                        turistas</span>
                                </h6>
                            </div>
                            <div class="col-md-3"></div>
