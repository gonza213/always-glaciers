                        ...
                        <div class="container">
                            ...
                            <div id="frmReservaR" class="col-md-12 col-sm-12 col-lg-12 col-xs-12 modulo-reservas">
                                <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12 sin-padd" id="reservaExc">
                                    <?php foreach ($planes as $key => $value) : ?>
                                        <?php if ($_GET["id"] == $value["id"]) : ?>
                                            <h4 class="color-negro txt-open m-t-0"><?php echo $value["titulo"]  ?></h4>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                ...
                                <div class="col-md-3 col-lg-3 col-sm-3 col-xs-12 txt-open text-right p-5">
                                    ...
                                    <?php foreach ($planes as $key => $value) : ?>
                                        ...
                                        <?php if ($_GET["id"] == $value["id"]) : ?>
                                            ...
                                            <hr>
                                            <button type="button" onclick="noFunciona()" style="height: 40px !important; margin-bottom: 5px;" class="btn  oe-btn-blue oe-btn-inline-icon btn-block btn3">
                                                <span data-btn-text="RESERVAR">RESERVAR</span></button>
                                            <form method="post">

                                                <a onclick="noFunciona()" style="cursor:pointer;" class=" btn oe-btn-red oe-btn-inline-icon  btn-block btn4"><i class="fa fa-cart-plus" style="background: none !important"></i>
                ...
                <div class="col-md-3 col-lg-3 col-sm-3 col-xs-12 txt-open text-right p-5">
                    ...
                    <?php foreach ($planes as $key => $value) : ?>
                        ...
                        <?php if ($_GET["id"] == $value["id"]) : ?>
                            ...
                            <hr>
                            <button style="height: 40px !important; margin-bottom: 5px;" class="btn  oe-btn-blue oe-btn-inline-icon btn-block btn3" onclick="reservar()">
                                <span data-btn-text="RESERVAR">RESERVAR</span></button>
