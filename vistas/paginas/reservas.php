    ...
    if (!$sumar) {
        ...
        foreach ($sumar as $key => $value) {
            if ($value["id_excursion"] == $id) {
                if ($value["SUM(cantidad)"] >= $excursion) {
                    echo '"' . $value["fecha_ingreso"] . '",';
                } else {
...
<main class="oe-blog" style="padding-top:0 !important;">
    <div id="imprimir<?php echo $_GET["id"] ?>">
        ...
        <section class="container oe-main-content p-18-15 information"
            data-uk-scrollspy="{cls:'animate-started',delay:300}" id="imprimir2">
                                    ...
                                    <div id="TA_selfserveprop997" class="TA_selfserveprop">
                                        <ul id="V7WBtkLwVk9" class="TA_links 8o0w0wu3e4">
                                            <li id="1W91ek5pDP7I" class="dtpyYRPd">
                                                <a target="_blank" href="<?php echo $value["trip_link"] ?>"><img
                                                        src="https://www.tripadvisor.com.ar/img/cdsi/img2/branding/150_logo-11900-2.png"
                                                        alt="TripAdvisor" /></a>
                                            </li>
                                        </ul>
                                    </div>
            ...
            <div class="container">
                ...
                <div id="frmReservaR" class="col-md-12 col-sm-12 col-lg-12 col-xs-12 modulo-reservas">
                        ...
                        <form name="frmReserva" action="" method="POST" style="margin:30px 0;">
                            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 m-resp">
                                ...
                                <div class="box-inputs">
                                    <input style="float:left;" type="text" id="datepickerEntradaR"
                                        class="input-datepicker input-datepicker-col" placeholder="Seleccione una fecha"
                                        readonly>
                                    <img class="ui-datepicker-trigger oculto" src="vistas/images/icn-calendario.png"
                                        alt="" title="">
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 m-resp">
                                ...
                                <div class="box-inputs">
                                    <input style="float:left;" type="text" id="datepickerSalidaR"
                                        class="input-datepicker input-datepicker-col" placeholder="Seleccione una fecha"
                                        readonly>
                                    <img class="ui-datepicker-trigger oculto" src="vistas/images/icn-calendario.png"
                                        alt="" title="">
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 m-resp">
                                ...
                                <div class="box-inputs">
                                    ...
                                    <input style="float:left; font-size: 24px" type="number" id="cantidadDias"
                                        class="input-datepicker input-datepicker-col text-center" value="1" readonly>
                                    <!-- <span class="fa fa-calendar blue icon"></span> -->
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 p-0">
                                ...
                                <div class="col-md-2 col-lg-2 col-sm-2 col-xs-4 p-0 text-center">
                                    <input type="hidden" name="precioRenta" id="precioRenta<?php echo $key + 1 ?>"
                                    ...
                                    <div class="panel-group panel-group-4">
                                        <div class="panel panel-default">
                                            <div class="panel-heading" style="background:#fff;">
                                                <span class="f-s-14"
                                                    id="tituloOpc<?php echo $key + 1 ?>"><?php echo $value["opcional"] ?></span>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3 col-xs-12 txt-open text-right p-5">
                        ...
                        <?php if ($_GET["id"] == $value["id"]) : ?>
                        <div class="mod-precio-1-cont mt-5" id="resultado2"
                            data-precio="<?php echo $value["precio_bajo"] ?>"
                            data-alto="<?php echo $value["precio_alto"] ?>">
                            <br>
                            ...
                            <div class="precio-celestes" id="precio-reserva">
                                ...
                                Total: <span>
                                    <sup>$ </sup>
                                    <sup>
                                        <input type="hidden" name="" id="subTotal"
                        ...
                        <hr>
                        <button type="button" onclick="reservarRenta()"
                            style="height: 40px !important; margin-bottom: 5px;"
                            class="btn  oe-btn-blue oe-btn-inline-icon btn-block btn3">
                ...
                <div id="frmCasiR" class="col-md-12 col-sm-12 col-lg-12 col-xs-12 modulo-reservas"
                    style="display: none">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php endif; ?>
                                <?php endforeach; ?>
                                <div class="col-md-12" id="contentRsm2"
                                    style="border: 1px solid #90EE90; height: 100px; background: #F8F8FF">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div id="frmReserva" class="col-md-12 col-sm-12 col-lg-12 col-xs-12 modulo-reservas">
                    ...
                    <form name="frmReserva" action="" method="POST" style="margin:30px 0;">
                        <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 m-resp">
                            ...
                            <div class="box-inputs">
                                <input style="float:left;" type="text" id="datepickerReserva"
                                    class="input-datepicker input-datepicker-col" placeholder="Seleccione una fecha"
                                    readonly>
                                <img class="ui-datepicker-trigger oculto" src="vistas/images/icn-calendario.png" alt=""
                                    title="">
                                <!-- <span class="fa fa-calendar blue icon"></span> -->
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 m-resp">
                            ...
                            <div class="dropdown show" id="turnosDropdown" data-drop="false">
                                <select class="btn styled-select slate dropdown-toggle" id="dropdownTurnos"
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 m-b-20">
                            ...
                            <div class="dropdown show" data-drop="false">
                                <div class="inner"></div>
                                <a class="btn styled-select slate paj dropdown-toggle" id="pasajeros"
                                    aria-haspopup="false" aria-expanded="false">
                                    Pasajeros
                                </a>
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 p-0">
                            ...
                            <div class="col-md-2 col-lg-2 col-sm-2 col-xs-4 p-0 text-center">
                                <input type="hidden" name="precioTraslado" id="precioTraslado<?php echo $key + 1 ?>"
                                    value="<?php echo $value["precio"] ?>">
                                <strong class="celeste-reserva">
                                    <sup>$</sup>
                                    <span class="f-s-16"><?php echo $value["precio"] ?></span>
                            ...
                            <div class="col-md-9 col-lg-9 col-sm-9 col-xs-7 p-0 m-b-20">
                                <div class="panel-group panel-group-4">
                                    <div class="panel panel-default">
                                        <div class="panel-heading" style="background:#fff;">
                                            <span class="f-s-14"
                                                id="tituloTraslado<?php echo $key + 1 ?>"><?php echo $value["opcional"] ?></span>
                                            <a class="collapsed subrayado f-s-13 azul-2" data-toggle="collapse"
                                                data-target="#collapse1<?php echo $key + 1 ?>">Ver detalle</a>
                                        </div>
                                        <div style="height: auto;" id="collapse1<?php echo $key + 1 ?>"
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 p-0">
                            ...
                            <div class="col-md-2 col-lg-2 col-sm-2 col-xs-4 p-0 text-center">
                                <input type="hidden" name="precioAlmuerzo" id="precioAlmuerzo<?php echo $key + 1 ?>"
                                    value="<?php echo $value["precio"] ?>">
                                <strong class="celeste-reserva">
                                    <sup>$</sup>
                                    <span class="f-s-16"><?php echo $value["precio"] ?></span>
                            ...
                            <div class="col-md-9 col-lg-9 col-sm-9 col-xs-7 p-0 m-b-20">
                                <div class="panel-group panel-group-4">
                                    <div class="panel panel-default">
                                        <div class="panel-heading" style="background:#fff;">
                                            <span class="f-s-14"
                                                id="tituloAlmuerzo<?php echo $key + 1 ?>"><?php echo $value["opcional"] ?></span>
                                            <a class="collapsed subrayado f-s-13 azul-2" data-toggle="collapse"
                            ...
                            <div class="col-md-1 col-lg-1 col-sm-1 col-xs-1 p-0 text-right">
                                <div class="checkbox" style="margin-top:0;">
                                    <input class="opcionales" type="checkbox" name="viandaRsm"
                                        id="viandaRsm<?php echo $key + 1 ?>" />
                                    <label for="viandaRsm<?php echo $key + 1 ?>"></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-lg-2 col-sm-2 col-xs-4 p-0 text-center">
                                <input type="hidden" name="precioVianda" id="precioVianda<?php echo $key + 1 ?>"
                                    value="<?php echo $value["precio"] ?>">
                                <strong class="celeste-reserva">
                                    <sup>$</sup>
                                    <span class="f-s-16"><?php echo $value["precio"] ?></span>
                            ...
                            <div class="col-md-9 col-lg-9 col-sm-9 col-xs-7 p-0 m-b-20">
                                <div class="panel-group panel-group-4">
                                    <div class="panel panel-default">
                                        <div class="panel-heading" style="background:#fff;">
                                            <span class="f-s-14"
                                                id="tituloVianda<?php echo $key + 1 ?>"><?php echo $value["opcional"] ?></span>
                                            <a class="collapsed subrayado f-s-13 azul-2" data-toggle="collapse"
                            ...
                            <div class="col-md-1 col-lg-1 col-sm-1 col-xs-1 p-0 text-right">
                                <div class="checkbox" style="margin-top:0;">
                                    <input class="opcionales" type="checkbox" name="navegacionRsm"
                                        id="navegacionRsm<?php echo $key + 1 ?>" />
                                    <label for="navegacionRsm<?php echo $key + 1 ?>"></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-lg-2 col-sm-2 col-xs-4 p-0 text-center">
                                <input type="hidden" name="precioNavegacion" id="precioNavegacion<?php echo $key + 1 ?>"
                                    value="<?php echo $value["precio"] ?>">
                                <strong class="celeste-reserva">
                                    <sup>$</sup>
                                    <span class="f-s-16"><?php echo $value["precio"] ?></span>
                            ...
                            <div class="col-md-9 col-lg-9 col-sm-9 col-xs-7 p-0 m-b-20">
                                <div class="panel-group panel-group-4">
                                    <div class="panel panel-default">
                                        <div class="panel-heading" style="background:#fff;">
                                            <span class="f-s-14"
                                                id="tituloNavegacion<?php echo $key + 1 ?>"><?php echo $value["opcional"] ?></span>
                                            <a class="collapsed subrayado f-s-13 azul-2" data-toggle="collapse"
                            ...
                            <div class="col-md-1 col-lg-1 col-sm-1 col-xs-1 p-0 text-right">
                                <div class="checkbox" style="margin-top:0;">
                                    <input class="opcionales" type="checkbox" name="entradaRsm"
                                        id="entradaRsm<?php echo $key + 1 ?>" />
                                    <label for="entradaRsm<?php echo $key + 1 ?>"></label>
                                </div>
                            </div>
                            <div class="col-md-2 col-lg-2 col-sm-2 col-xs-4 p-0 text-center">
                                <input type="hidden" name="precioEntrada" id="precioEntrada<?php echo $key + 1 ?>"
                                    value="<?php echo $value["precio"] ?>">
                                <strong class="celeste-reserva">
                                    <sup>$</sup>
                                    <span class="f-s-16"><?php echo $value["precio"] ?></span>
                            ...
                            <div class="col-md-9 col-lg-9 col-sm-9 col-xs-7 p-0 m-b-20">
                                <div class="panel-group panel-group-4">
                                    <div class="panel panel-default">
                                        <div class="panel-heading" style="background:#fff;">
                                            <span class="f-s-14"
                                                id="tituloEntrada<?php echo $key + 1 ?>"><?php echo $value["opcional"] ?></span>
                                            <a class="collapsed subrayado f-s-13 azul-2" data-toggle="collapse"
                ...
                <div class="col-md-3 col-lg-3 col-sm-3 col-xs-12 txt-open text-right p-5">
                    ...
                    <?php if ($_GET["id"] == $value["id"]) : ?>
                    <div class="mod-precio-1-cont mt-5" id="resultado" data-precio="<?php echo $value["precio_bajo"] ?>"
                        data-ninos="<?php echo $value["precio_ninos"] ?>"
                        data-alto="<?php echo $value["precio_alto"] ?>">
                        <br>
                        <div>
                    ...
                    <hr>
                    <button style="height: 40px !important; margin-bottom: 5px;" id="btn-reservar"
                        data-category="<?php echo $categoria ?>"
                        class="btn  oe-btn-blue oe-btn-inline-icon btn-block btn3" onclick="reservar()">
                        <span data-btn-text="RESERVAR">RESERVAR</span></button>

                    <?php if ($categoria == $categoria_carrito) : ?>
                    <form method="post">

                        <a id="enviarCarrito" style="cursor:pointer;" onclick="anadirCarrito()"
                            class=" btn oe-btn-red oe-btn-inline-icon  btn-block btn4"><i class="fa fa-cart-plus"
                                style="background: none !important"></i>
                            <span data-btn-text=""> Añadir al carrito</span></a>
                    </form>
                    ...
                    <form method="post">
                        ...
                        <a id="enviarCarrito" style="cursor:pointer;" onclick="noPermitido()"
                            class=" btn oe-btn-red oe-btn-inline-icon  btn-block btn4"><i class="fa fa-cart-plus"
                                style="background: none !important"></i>
                            <span data-btn-text=""> Añadir al carrito</span></a>
                    </form>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <?php endforeach; ?>
                            <div class="col-md-12" id="contentRsm"
                                style="border: 1px solid #90EE90; height: 100px; background: #F8F8FF">
                            </div>
                        </div>
                    </div>
