                    ...
                    <div class="modulo-destacados">
                        ...
                        <div class="col-xs-6 col-md-6 col-sm-6 m-p-0">
                            <div class="precio-listado"><sup>$</sup>
                                <b id="monto"><?php echo $value["precio_bajo"]; ?></b>
                                <b id="resultado"></b>
                                <sup id="moneda">
                                    ARG </sup>
                                <sup id="moneda2"></sup>
            ...
            <div class="col-md-3 col-sm-6 oe-mbot col-exc">
                <div class="mod-lista-excu">
                    <div class="modulo-destacados">
                        ...
                        <div class="col-xs-6 col-md-6 col-sm-6 m-p-0">
                            <div class="precio-listado"><sup>$</sup>
                                <?php echo $value["precio_bajo"] ?> <sup>
                                    ARS </sup>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 transferencia">
                            <span class="small text-white"></span>
                            <a data-toggle="modal" data-target="#exampleModal" style="cursor:pointer"><span
                                    class="small text-white" style="font-weight: bold;">Paga
                                    con transferencia
                                    bancaria y ahorra 1,5%</span></a>
                        </div>
                    </div>
