...
<?php endforeach; ?>
    ...
    <div class="container">
        <?php foreach ($plan as $key => $value) : ?>
            ...
            <?php if ($_GET["id"] == $value["id"]) : ?>
                <h2 class="oe-heading-2">Otras excursiones que ofrecen <?php echo $value["subcategoria"] ?></h2>
            <?php endif; ?>
        <?php endforeach; ?>
    </div>
    <div class="container oe-main-content oe-col-non-pd">
        <div class="row oe-row m-b-40">
            ...
            $otras = ControladorRelacionOtras::ctrMostrarRelacionOtras($id);

            ?>

            <?php foreach ($otras as $key => $value) : ?>
                <div class="col-md-3 col-sm-6 oe-mbot col-exc">
                    <div class="mod-lista-excu">
                        <div class="modulo-destacados">
                            <section>
                                <span>
                                    ...
                                    <img src="<?php echo $servidor . $value["banner"]; ?>" class="img-responsive" style="width: 320px !important; height: 260px !important">
                                    <form id="my_form<?php echo $value["id"]; ?>" method="post" action="index.php?pagina=reserva&id=<?php echo $value["id"]; ?>" method="post">
                                        <input type="hidden" name="fecha" value="<?php echo date('y-m-d') ?>">
                                        <a href="javascript:{}" onclick="document.getElementById('my_form<?php echo $value["id"]; ?>').submit();" class="over" title="ver ficha" style="border: none;">
                                            <div class="esconde-767">
                            ...
                            <div class="col-md-12 transferencia">
                                <span class="small text-white"></span>
                                <a data-toggle="modal" data-target="#exampleModal" style="cursor:pointer"><span class="small text-white" style="font-weight: bold;">Paga
                                        con transferencia
                                        bancaria y ahorra 1,5%</span></a>
                            </div>
                        </div>
